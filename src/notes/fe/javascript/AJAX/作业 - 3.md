...
https://ks.wjx.top/vm/YLDl1RR.aspx#
...
https://apifox.com/apidoc/shared-1b0dd84f-faa8-435d-b355-5a8a329e34a8/api-87684195

#### 效果演示

![hero_list](md_img/hero_list.gif)
...
function getHero() {
  const res = axios({
    ...
    console.log(res);
    const listHero = document.querySelector('.list')
    listHero.innerHTML = res.data.data.map(hero => {
      return `
        <li>
...
![image-20231219161514395](md_img/image-20231219161514395.png)
...
![image-20231219161523239](md_img/image-20231219161523239.png)
