<template><div><h1 id="三、编程思想-构造函数-原型-综合案例" tabindex="-1"><a class="header-anchor" href="#三、编程思想-构造函数-原型-综合案例" aria-hidden="true">#</a> 三、编程思想 | 构造函数 | 原型 | 综合案例</h1>
<h2 id="编程思想" tabindex="-1"><a class="header-anchor" href="#编程思想" aria-hidden="true">#</a> 编程思想</h2>
<h3 id="面向过程介绍" tabindex="-1"><a class="header-anchor" href="#面向过程介绍" aria-hidden="true">#</a> 面向过程介绍</h3>
<p>面向过程就是列出解决问题的每一个步骤，然后用函数把这些步骤一步一个脚印的实现，使用的时候再一个一个依次调用就可以了。</p>
<p>之前所写的就是面向过程的方法。</p>
<h3 id="面向对象介绍" tabindex="-1"><a class="header-anchor" href="#面向对象介绍" aria-hidden="true">#</a> 面向对象介绍</h3>
<p>面向对象就是把事务分解成一个一个对象，然后由对象之间分工与合作。</p>
<p>举个栗子：</p>
<p>比如说，盖浇饭，那肯定是先正好饭，然后码子分别做好，需要哪些码子盖上去就好了。</p>
<figure><img src="@source/notes/fe/javascript/JavaScript 进阶/md_img/image-20231208101307288.png" alt="image-20231208101307288" tabindex="0" loading="lazy"><figcaption>image-20231208101307288</figcaption></figure>
<p>所以，面向对象是以对象功能来划分问题，而不是步骤。</p>
<p>公司越大，面向对象就越需要</p>
<h3 id="两者对比" tabindex="-1"><a class="header-anchor" href="#两者对比" aria-hidden="true">#</a> 两者对比</h3>
<table>
<thead>
<tr>
<th></th>
...
<tr>
<td>优点</td>
<td>性能比面向对象高，适合跟硬件联系很紧密的东西，例如单片机就采用面向过程编程。</td>
...
<p>两者没有谁比谁更优，只有更适合。于前端而言，面向过程会更多；而JAVA则面向对象更多。</p>
<h2 id="构造函数" tabindex="-1"><a class="header-anchor" href="#构造函数" aria-hidden="true">#</a> 构造函数</h2>
<p>封装是面向对象思想比较重要的一部分；</p>
<p>JS面向对象可以通过构造函数实现封装。</p>
<p>构造函数虽然好用，但是会存在 <strong>浪费内存</strong> 的问题</p>
<p>比如：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">Star</span><span class="token punctuation">(</span><span class="token parameter">uname<span class="token punctuation">,</span> age</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>你会发现，明明都是同一个函数 <code v-pre>Star</code> ，但是两个的 <code v-pre>sing</code> 就是不一样，这是因为创建的时候在内存空间开辟了两个不一样的内存地址去引用，所以就会造成浪费内存的问题。</p>
<p>既然对象里面的函数是同一个，能否够用一个呢？</p>
<h2 id="原型" tabindex="-1"><a class="header-anchor" href="#原型" aria-hidden="true">#</a> 原型</h2>
<p>原型，其实就是构造函数里面的一个 <code v-pre>prototype</code> 属性，但是就是以一个对象的形式存在的，所以也会称为原型对象。</p>
<p>因此，通过原型分配的函数是所有对象所共享的。</p>
<p>所以，要想节省内存，提高性能，上面的代码应该改成：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">Star</span><span class="token punctuation">(</span><span class="token parameter">uname<span class="token punctuation">,</span> age</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">this</span><span class="token punctuation">.</span>uname <span class="token operator">=</span> uname
  <span class="token keyword">this</span><span class="token punctuation">.</span>age <span class="token operator">=</span> age
...
<p class="hint-container-title">所以，以后写代码要注意：</p>
<ol>
<li>公共的属性要写到 构造函数里面</li>
<li>公共的方法写到 原型对象身上</li>
</ol>
</div>
<p>而对于 <code v-pre>this</code> 的指向：构造函数和原型对象中的this</p>
<h3 id="constructor-属性" tabindex="-1"><a class="header-anchor" href="#constructor-属性" aria-hidden="true">#</a> constructor 属性</h3>
<p>每个原型对象里面都会有一个 <code v-pre>constructor</code> 属性，这个属性指向原型对象的构造函数。但是不是指向调用这个原型的对象哦</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">Star</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="使用场景" tabindex="-1"><a class="header-anchor" href="#使用场景" aria-hidden="true">#</a> 使用场景</h4>
<p>如果有多个对象的方法，我们可以给原型对象采取对象形式赋值</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">Star</span><span class="token punctuation">(</span><span class="token parameter">uname</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">this</span><span class="token punctuation">.</span>uname <span class="token operator">=</span> uname
<span class="token punctuation">}</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这样的话 <code v-pre>constructor</code> 就不知道指向谁了，因为 <code v-pre>prototype</code> 的操作更像是重新赋值而不是以追加的形式进行，因此我们可以在修改后的原型对象中，添加一个 <code v-pre>constructor</code> 指向原来的构造函数。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">Star</span><span class="token punctuation">(</span><span class="token parameter">uname</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">this</span><span class="token punctuation">.</span>uname <span class="token operator">=</span> uname
<span class="token punctuation">}</span>
<span class="token class-name">Star</span><span class="token punctuation">.</span>prototype <span class="token operator">=</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>下一个问题：</p>
<p>构造函数可以创建实例对象，构造函数还有一个原型对象，一些公共的属性或者方法放到这个原型对象身上，但是为什么实例对象可以访问原型对象里面的属性和方法？</p>
<figure><img src="@source/notes/fe/javascript/JavaScript 进阶/md_img/image-20231208155428662.png" alt="image-20231208155428662" tabindex="0" loading="lazy"><figcaption>image-20231208155428662</figcaption></figure>
<h3 id="对象原型" tabindex="-1"><a class="header-anchor" href="#对象原型" aria-hidden="true">#</a> 对象原型</h3>
<p>答案就是，对象都会有一个属性 <code v-pre>__proto__</code> 指向构造函数 <code v-pre>prototype</code> 原型对象，之所以对象可以使用构造函数 <code v-pre>prototype</code> 原型对象的属性和方法，就是因为对象有 <code v-pre>__proto__</code> 原型的存在。</p>
<figure><img src="@source/notes/fe/javascript/JavaScript 进阶/md_img/image-20231208155630410.png" alt="image-20231208155630410" tabindex="0" loading="lazy"><figcaption>image-20231208155630410</figcaption></figure>
<p>这三个，对象原型 <code v-pre>__proto__</code> 指向 该构造函数的原型对象</p>
<p>对象原型里面的 <code v-pre>constructor</code> 指向 构造函数 <code v-pre>Star</code></p>
<figure><img src="@source/notes/fe/javascript/JavaScript 进阶/md_img/image-20231208162550865.png" alt="image-20231208162550865" tabindex="0" loading="lazy"><figcaption>image-20231208162550865</figcaption></figure>
<h3 id="原型继承" tabindex="-1"><a class="header-anchor" href="#原型继承" aria-hidden="true">#</a> 原型继承</h3>
<p>继承是面向对象编程的另一个特性，通过继承进一步提升代码封装的程度。JavaScript中大多是借助原型对象实现继承的特性。</p>
<p>示例：</p>
...
<figure><img src="@source/notes/fe/javascript/JavaScript 进阶/md_img/image-20231208172748274.png" alt="image-20231208172748274" tabindex="0" loading="lazy"><figcaption>image-20231208172748274</figcaption></figure>
<p>这个就是原型继承</p>
<p>当然，男人也是人，一样也可以继承人类的属性。但是，毕竟男女有别，现在想要给女人加多一个属性方法：</p>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span><span class="token punctuation">></span></span><span class="token script"><span class="token language-javascript">
  <span class="token keyword">const</span> Person <span class="token operator">=</span> <span class="token punctuation">{</span>
    <span class="token literal-property property">eyes</span><span class="token operator">:</span> <span class="token number">2</span><span class="token punctuation">,</span>
    <span class="token literal-property property">head</span><span class="token operator">:</span> <span class="token number">1</span>
...
<figure><img src="@source/notes/fe/javascript/JavaScript 进阶/md_img/image-20231208173754391.png" alt="image-20231208173754391" tabindex="0" loading="lazy"><figcaption>image-20231208173754391</figcaption></figure>
<p>出现这个问题的原因是因为男人和女人同时使用了同一个对象 <code v-pre>Person</code> ，根据引用类型的特点，他们都指向同一个对象，修改一个就会都影响。</p>
<p>怎么解决？也不难</p>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span><span class="token punctuation">></span></span><span class="token script"><span class="token language-javascript">
...
<figure><img src="@source/notes/fe/javascript/JavaScript 进阶/md_img/image-20231208174309041.png" alt="image-20231208174309041" tabindex="0" loading="lazy"><figcaption>image-20231208174309041</figcaption></figure>
<p>其实也不难理解，因为 <code v-pre>new</code> 每次都会创建一个新的对象，因此 <code v-pre>Woman.prototype = new Person()</code> 和  <code v-pre>Man.prototype = new Person()</code> 相当于指向了两个不同的内存地址的 <code v-pre>Person</code> ，所以，这样就能很好解决了引用了同一个对象的问题。</p>
<h3 id="原型链-高频面试题" tabindex="-1"><a class="header-anchor" href="#原型链-高频面试题" aria-hidden="true">#</a> 原型链（高频面试题）</h3>
<p>这个知识点如果难以理解，可以结合这个<a href="https://www.bilibili.com/video/BV1Y84y1L7Nn/?p=184&amp;vd_source=ce2373d3d93ecee4088b1954ccc2db50" target="_blank" rel="noopener noreferrer">视频<ExternalLinkIcon/></a></p>
<p>基于原型对象的继承使得不同构造函数的原型对象关联在一起，并且这种关联的关系是一种链状的结构，这几种关系称为原型链。</p>
<figure><img src="@source/notes/fe/javascript/JavaScript 进阶/md_img/image-20231211101104698.png" alt="image-20231211101104698" tabindex="0" loading="lazy"><figcaption>image-20231211101104698</figcaption></figure>
<div class="hint-container tip">
<p class="hint-container-title">总结一下</p>
<ol>
<li>只要是对象都有原型 <code v-pre>__proto__</code> ， <code v-pre>__proto__</code> 指向原型对象</li>
<li>只要是原型对象里面就有 <code v-pre>constructor</code> ，指向创造我的构造函数</li>
</ol>
</div>
<p>原型链其实只是一个查找规则。如果想要理解平时的使用场景，可以点击查看<a href="https://www.bilibili.com/video/BV1Y84y1L7Nn/?p=184&amp;share_source=copy_web&amp;vd_source=1d915d270b1683048b8999b2b3802333&amp;t=1128" target="_blank" rel="noopener noreferrer">这里<ExternalLinkIcon/></a></p>
<p><code v-pre>__proto__</code> 的意义存在在于为对象成员查找机制提供一个方向，或者一条路线。</p>
<p>当然，也可以使用 <code v-pre>instaceof</code> 运算符用于检测构造函数的 <code v-pre>prototype</code> 属性是否出现在某个实例对象的原型链上。</p>
<h2 id="综合案例" tabindex="-1"><a class="header-anchor" href="#综合案例" aria-hidden="true">#</a> 综合案例</h2>
<h3 id="消息提示对象封装" tabindex="-1"><a class="header-anchor" href="#消息提示对象封装" aria-hidden="true">#</a> 消息提示对象封装</h3>
<h4 id="需求" tabindex="-1"><a class="header-anchor" href="#需求" aria-hidden="true">#</a> 需求</h4>
<ol>
<li>定义模态框 <code v-pre>Modal</code> 构造函数，用来创建对象</li>
<li>模态框具备打开功能 <code v-pre>open</code> 方法（按钮点击可以打开模态框）</li>
<li>模态框具备关闭功能 <code v-pre>close</code> 方法</li>
</ol>
...
<li><code v-pre>Modal</code> 构造函数制作</li>
</ol>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span><span class="token punctuation">></span></span><span class="token script"><span class="token language-javascript">
...
<li><code v-pre>close</code> 方法</li>
</ol>
<div class="language-html line-numbers-mode" data-ext="html"><pre v-pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>script</span><span class="token punctuation">></span></span><span class="token script"><span class="token language-javascript">
	<span class="token class-name">Modal</span><span class="token punctuation">.</span>prototype<span class="token punctuation">.</span><span class="token function-variable function">open</span> <span class="token operator">=</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token operator">...</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="@source/notes/fe/javascript/JavaScript 进阶/md_img/image-20231211151801113.png" alt="image-20231211151801113" tabindex="0" loading="lazy"><figcaption>image-20231211151801113</figcaption></figure>
<figure><img src="@source/notes/fe/javascript/JavaScript 进阶/md_img/image-20231211151809619.png" alt="image-20231211151809619" tabindex="0" loading="lazy"><figcaption>image-20231211151809619</figcaption></figure>
</div></template>
