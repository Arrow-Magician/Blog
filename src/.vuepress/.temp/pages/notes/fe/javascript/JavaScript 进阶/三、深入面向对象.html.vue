<template><div><h1 id="三、深入面向对象" tabindex="-1"><a class="header-anchor" href="#三、深入面向对象" aria-hidden="true">#</a> 三、深入面向对象</h1>
...
<p><img src="@source/notes/fe/javascript/JavaScript 进阶/md_img/image-20231208101307288.png" alt="image-20231208101307288" loading="lazy"></p>
...
<p><img src="@source/notes/fe/javascript/JavaScript 进阶/md_img/image-20231208155428662.png" alt="image-20231208155428662" loading="lazy"></p>
...
<p><img src="@source/notes/fe/javascript/JavaScript 进阶/md_img/image-20231208155630410.png" alt="image-20231208155630410" loading="lazy"></p>
<p>这三个，对象原型 <code v-pre>__proto__</code> 指向 该构造函数的原型对象</p>
<p>对象原型里面的 <code v-pre>constructor</code> 指向 构造函数 <code v-pre>Star</code></p>
<p><img src="@source/notes/fe/javascript/JavaScript 进阶/md_img/image-20231208162550865.png" alt="image-20231208162550865" loading="lazy"></p>
...
<p><img src="@source/notes/fe/javascript/JavaScript 进阶/md_img/image-20231208172748274.png" alt="image-20231208172748274" loading="lazy"></p>
<p>这个就是原型继承</p>
...
<p><img src="@source/notes/fe/javascript/JavaScript 进阶/md_img/image-20231208173754391.png" alt="image-20231208173754391" loading="lazy"></p>
...
<p><img src="@source/notes/fe/javascript/JavaScript 进阶/md_img/image-20231208174309041.png" alt="image-20231208174309041" loading="lazy"></p>
...
<p><img src="@source/notes/fe/javascript/JavaScript 进阶/md_img/image-20231211101104698.png" alt="image-20231211101104698" loading="lazy"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="@source/notes/fe/javascript/JavaScript 进阶/md_img/image-20231211151801113.png" alt="image-20231211151801113" loading="lazy"></p>
<p><img src="@source/notes/fe/javascript/JavaScript 进阶/md_img/image-20231211151809619.png" alt="image-20231211151809619" loading="lazy"></p>
</div></template>
